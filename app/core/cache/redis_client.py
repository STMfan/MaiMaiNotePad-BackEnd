...
class RedisClient:
    ...
    async def delete(self, key: str) -> bool:
        ...
        try:
            ...
            raise RedisError(f"DELETE 操作失败: {e}")
    ...
    async def exists(self, key: str) -> bool:
        ...
        try:
            ...
            raise RedisError(f"EXISTS 操作失败: {e}")
    ...
    async def expire(self, key: str, ttl: int) -> bool:
        ...
        try:
            ...
            raise RedisError(f"EXPIRE 操作失败: {e}")
    ...
    async def delete_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            raise RedisError(f"DELETE_PATTERN 操作失败: {e}")
