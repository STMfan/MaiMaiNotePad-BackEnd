...
from tests.helpers.exception_injector import (
    ExceptionInjector,
    ExceptionType,
    create_injector
)
...
class TestIntegrationScenarios:
    ...
    def test_permission_error_resource_access_scenarios(self):
        ...
        # 测试资源访问权限失败
        with injector.inject_permission_error(
            permission_type="resource_access",
            error_message="Cannot access this persona"
        ):
            pass
        ...
        with injector.inject_permission_error(
            permission_type="resource_access",
            error_message="Cannot modify this message"
        ):
            pass
