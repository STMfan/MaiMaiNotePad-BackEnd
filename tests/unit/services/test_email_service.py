...
class TestSendEmail:
    ...
    def test_send_email_success(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            service = EmailService()
            service.send_email(receiver="recipient@example.com", subject="Test Subject", content="Test content")
    ...
    def test_send_email_with_verification_code(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            service.send_email(
                receiver="user@example.com", subject="验证码", content=f"您的验证码是: {verification_code}"
            )
    ...
    def test_send_email_with_notification(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            service = EmailService()
            service.send_email(receiver="user@example.com", subject="系统通知", content="您有一条新消息")
    ...
    def test_send_email_authentication_error(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            with pytest.raises(RuntimeError) as exc_info:
                service.send_email(receiver="recipient@example.com", subject="Test", content="Test")
...
class TestConvenienceFunction:
    ...
    def test_send_email_function(self, mock_email_service_class):
        ...
        send_email(receiver="recipient@example.com", subject="Test Subject", content="Test content")
        ...
        mock_service.send_email.assert_called_once_with("recipient@example.com", "Test Subject", "Test content")
    ...
    def test_send_email_function_propagates_errors(self, mock_email_service_class):
        ...
        with pytest.raises(RuntimeError) as exc_info:
            send_email(receiver="recipient@example.com", subject="Test", content="Test")
...
class TestEmailMessageFormat:
    ...
    def test_email_message_has_correct_headers(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            service = EmailService()
            service.send_email(receiver="recipient@example.com", subject="测试主题", content="测试内容")
    ...
    def test_email_content_is_utf8_encoded(self, mock_smtp_ssl):
        ...
        with patch("app.services.email_service.settings") as mock_settings:
            ...
            service.send_email(receiver="recipient@example.com", subject="中文主题", content=chinese_content)
