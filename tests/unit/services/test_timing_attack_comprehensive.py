...
class TestTimingAttackProtection:
    ...
    def test_constant_time_response_for_existing_and_nonexisting_users(self, mock_verify, mock_sleep):
        """测试存在和不存在的用户响应时间一致性
    ...
    def test_password_verification_always_performed(self, mock_verify, mock_sleep):
        ...
        **Validates: Requirements FR3 (NFR4 - 测试安全)**
        ...
        test_cases = [
            ...
            {"username": "existing", "user_exists": True, "expected_hash": "$2b$12$real.hash.for.user"},
        ]
