...
class TestKnowledgeEdgeCases:
    ...
    def test_update_knowledge_base_moderator_can_update(self, moderator_client, factory):
        ...
        response = moderator_client.put(
            f"/api/knowledge/{kb.id}",
            json={"description": "Moderator updated"}
        )
...
class TestKnowledgeDatabaseErrorHandling:
    ...
    def test_star_knowledge_base_unique_constraint_violation(self, authenticated_client, test_user, factory, monkeypatch):
...
class TestKnowledgeFileOperationErrors:
    ...
    def test_download_knowledge_base_disk_space_insufficient(self, authenticated_client, test_user, factory, monkeypatch):
...
class TestKnowledgePermissionCombinations:
    ...
    def test_private_kb_access_by_non_owner(self, authenticated_client, factory):
        ...
        data = response.json()
        assert "权限" in data.get("error", {}).get("message", "") or "permission" in data.get("error", {}).get("message", "").lower()
    ...
    def test_update_kb_by_moderator_allowed(self, moderator_client, factory):
        ...
        response = moderator_client.put(
            f"/api/knowledge/{kb.id}",
            json={"description": "Moderator update"}
        )
    ...
    def test_update_public_kb_content_field_allowed(self, authenticated_client, test_user, factory):
        ...
        response = authenticated_client.put(
            f"/api/knowledge/{kb.id}",
            json={"content": "New supplementary content"}
        )
...
class TestKnowledgeZipDownloadErrorHandling:
    ...
    def test_download_kb_with_special_characters_in_filename(self, authenticated_client, test_user, factory, monkeypatch):
