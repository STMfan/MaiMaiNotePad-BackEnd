...
class TestGetComments:
    ...
    def test_get_comments_for_knowledge_base_success(
        ...
        response = authenticated_client.get(
            f"/api/comments?target_type=knowledge&target_id={kb.id}"
        )
    ...
    def test_get_comments_for_persona_card_success(
        self, authenticated_client: TestClient, test_db: Session, factory
    ):
        ...
        response = authenticated_client.get(
            f"/api/comments?target_type=persona&target_id={pc.id}"
        )
    ...
    def test_get_comments_invalid_target_type(
...
class TestCreateComment:
    ...
    def test_create_comment_on_knowledge_base_success(
        ...
        # Verify in database
        comment = test_db.query(Comment).filter(
            Comment.target_id == kb.id
        ).first()
    ...
    def test_create_comment_too_long_fails(
        self, authenticated_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_create_comment_invalid_target_type_fails(
        self, authenticated_client: TestClient, test_db: Session
    ):
    ...
    def test_create_comment_nonexistent_target_fails(
        self, authenticated_client: TestClient, test_db: Session
    ):
    ...
    def test_create_comment_nonexistent_parent_fails(
        self, authenticated_client: TestClient, test_db: Session, factory
    ):
...
class TestReactComment:
    ...
    def test_clear_reaction_success(
        self, authenticated_client: TestClient, test_db: Session, test_user: User, factory
    ):
    ...
    def test_react_invalid_action_fails(
        self, authenticated_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_react_nonexistent_comment_fails(
        self, authenticated_client: TestClient, test_db: Session
    ):
        ...
        """
        response = authenticated_client.post(
            f"/api/comments/{uuid.uuid4()}/react",
            json={"action": "like"}
        )
        
        assert_error_response(response, [404], ["不存在"])
    
    def test_react_deleted_comment_fails(
        self, authenticated_client: TestClient, test_db: Session, factory
    ):
...
class TestDeleteComment:
    ...
    def test_moderator_can_delete_any_comment(
    ...
    def test_delete_nonexistent_comment_fails(
        self, authenticated_client: TestClient, test_db: Session
    ):
...
class TestRestoreComment:
    ...
    def test_admin_can_restore_any_comment(
        self, admin_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_moderator_can_restore_any_comment(
        self, moderator_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_restore_nonexistent_comment_fails(
        self, authenticated_client: TestClient, test_db: Session
    ):
...
class TestCommentAuthentication:
    ...
    def test_get_comments_requires_authentication(
        self, client: TestClient, test_db: Session, factory
    ):
    ...
    def test_react_comment_requires_authentication(
        self, client: TestClient, test_db: Session, factory
    ):
    ...
    def test_restore_comment_requires_authentication(
        self, client: TestClient, test_db: Session, factory
    ):
