...
class TestGetPendingKnowledgeBases:
    ...
    def test_get_pending_knowledge_bases_as_admin_success(
        ...
        kb3 = factory.create_knowledge_base(
            uploader=user,
            name="Public KB",
            is_pending=False,
            is_public=True
    ...
    def test_get_pending_knowledge_bases_unauthenticated_fails(
    ...
    def test_get_pending_knowledge_bases_with_pagination(
        self, admin_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_get_pending_knowledge_bases_with_name_filter(
        self, admin_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_get_pending_knowledge_bases_with_sorting(
        self, admin_client: TestClient, test_db: Session, factory
    ):
...
class TestGetPendingPersonaCards:
    ...
    def test_get_pending_persona_cards_as_admin_success(
        self, admin_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_get_pending_persona_cards_with_pagination(
        self, admin_client: TestClient, test_db: Session, factory
    ):
    ...
    def test_get_pending_persona_cards_with_name_filter(
        self, admin_client: TestClient, test_db: Session, factory
    ):
...
class TestApproveKnowledgeBase:
    ...
    def test_approve_nonexistent_knowledge_base_fails(
...
class TestRejectKnowledgeBase:
    ...
    def test_reject_knowledge_base_as_admin_success(
        ...
        response = admin_client.post(
            f"/api/review/knowledge/{kb.id}/reject",
    ...
    def test_reject_nonexistent_knowledge_base_fails(
        self, admin_client: TestClient, test_db: Session
    ):
        ...
        fake_id = str(uuid.uuid4())
        response = admin_client.post(
            f"/api/review/knowledge/{fake_id}/reject",
            json={"reason": "测试"}
        )
...
class TestApprovePersonaCard:
    ...
    def test_approve_nonexistent_persona_card_fails(
        self, admin_client: TestClient, test_db: Session
    ):
...
class TestRejectPersonaCard:
    ...
    def test_reject_nonexistent_persona_card_fails(
        self, admin_client: TestClient, test_db: Session
    ):
        ...
        fake_id = str(uuid.uuid4())
        response = admin_client.post(
            f"/api/review/persona/{fake_id}/reject",
            json={"reason": "测试"}
        )
