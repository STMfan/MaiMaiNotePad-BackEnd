...
class BoundaryValueGenerator:
    ...
    def generate_null_combinations(
        self,
        function: Callable,
    ...
    def generate_string_boundaries(
        self,
    ...
    def generate_boolean_boundaries(self) -> List[BoundaryValue]:
        ...
        return [
            ...
            BoundaryValue(
                value=1,
                description="Truthy integer (1)",
                expected_behavior="handle_gracefully",
                category="boundary"
            ),
            BoundaryValue(
                value=0,
                description="Falsy integer (0)",
                expected_behavior="handle_gracefully",
                category="boundary"
            ),
            BoundaryValue(
    ...
    def generate_all_boundaries(
        self,
        value_type: Optional[str] = None
    ) -> Dict[str, List[BoundaryValue]]:
        """
        生成所有类型的边界值测试用例
