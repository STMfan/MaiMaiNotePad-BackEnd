...
def assert_error_response(response, expected_status_codes: Union[int, List[int]], expected_message_keywords: Union[str, List[str]]):
    """
    断言错误响应格式和内容
