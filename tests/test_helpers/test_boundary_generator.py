...
class TestBoundaryValueGenerator:
    ...
    def test_generate_dict_boundaries(self, generator):
        ...
        # 验证包含 None 值的字典
        assert any(
            None in bv.value.values() for bv in dict_boundaries if isinstance(bv.value, dict) and len(bv.value) > 0
        )
    ...
    def test_generate_test_cases_string(self, generator):
        ...
        test_cases = generator.generate_test_cases(
            function=sample_function, param_name="name", param_type="string", max_length=100
        )
    ...
    def test_generate_test_cases_integer(self, generator):
        ...
        test_cases = generator.generate_test_cases(
            function=sample_function, param_name="age", param_type="integer", min_value=0, max_value=150
        )
    ...
    def test_generate_test_cases_list(self, generator):
        ...
        test_cases = generator.generate_test_cases(
            function=sample_function, param_name="items", param_type="list", max_length=10
        )
    ...
    def test_generate_test_cases_unsupported_type(self, generator):
        ...
        with pytest.raises(ValueError, match="Unsupported parameter type"):
            generator.generate_test_cases(function=sample_function, param_name="value", param_type="unsupported_type")
    ...
    def test_boundary_value_default_values(self):
        ...
        bv = BoundaryValue(value="test", description="Test value")
    ...
    def test_list_boundaries_with_element_type(self, generator):
        ...
        assert any(
            all(isinstance(x, int) for x in bv.value)
            for bv in int_list_boundaries
            if isinstance(bv.value, list) and len(bv.value) > 0
        )

        # 测试浮点数类型
        float_list_boundaries = generator.generate_list_boundaries(max_length=5, element_type=float)
        assert any(
            all(isinstance(x, float) for x in bv.value)
            for bv in float_list_boundaries
            if isinstance(bv.value, list) and len(bv.value) > 0
        )
        ...
        assert any(
            all(isinstance(x, str) for x in bv.value)
            for bv in str_list_boundaries
            if isinstance(bv.value, list) and len(bv.value) > 0
        )
    ...
    def test_generate_null_test_cases_basic(self, generator):
        ...
        test_cases = generator.generate_null_test_cases(
            function=sample_function, param_name="data", include_nested=False
        )
    ...
    def test_generate_null_test_cases_with_nested(self, generator):
        ...
        test_cases = generator.generate_null_test_cases(
            function=sample_function, param_name="data", include_nested=True
        )
    ...
    def test_generate_null_test_cases_descriptions(self, generator):
        ...
        test_cases = generator.generate_null_test_cases(function=my_function, param_name="param", include_nested=True)
    ...
    def test_generate_null_combinations_single_param(self, generator):
        ...
        test_cases = generator.generate_null_combinations(
            function=sample_function, param_names=["username", "email", "password"]
        )
    ...
    def test_generate_null_combinations_all_params(self, generator):
        ...
        test_cases = generator.generate_null_combinations(function=sample_function, param_names=["param1", "param2"])
    ...
    def test_generate_null_combinations_multiple_params(self, generator):
        ...
        test_cases = generator.generate_null_combinations(
            function=sample_function, param_names=["param1", "param2", "param3"]
        )
    ...
    def test_generate_null_combinations_single_param_only(self, generator):
        ...
        test_cases = generator.generate_null_combinations(function=sample_function, param_names=["param"])
    ...
    def test_null_combinations_structure(self, generator):
        ...
        # 验证每个测试用例都有必需的字段
        required_fields = ["function", "params", "description", "expected_behavior", "category", "test_type"]
    ...
    def test_generate_max_value_test_cases_string(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=validate_username, param_name="username", param_type="string", max_value=50
        )
    ...
    def test_generate_max_value_test_cases_integer(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=validate_age, param_name="age", param_type="integer", max_value=150
        )
    ...
    def test_generate_max_value_test_cases_float(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=validate_temperature, param_name="temp", param_type="float", max_value=1000.0
        )
    ...
    def test_generate_max_value_test_cases_list(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=process_items, param_name="items", param_type="list", max_value=10, element_type=str
        )
    ...
    def test_generate_max_value_test_cases_dict(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=process_config, param_name="config", param_type="dict", max_value=5
        )
    ...
    def test_generate_max_value_test_cases_unsupported_type(self, generator):
        ...
        with pytest.raises(ValueError, match="Unsupported parameter type for max value generation"):
            generator.generate_max_value_test_cases(
                function=sample_function, param_name="value", param_type="unsupported_type"
            )
    ...
    def test_generate_max_value_test_cases_default_max(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=process_text, param_name="text", param_type="string"
        )
    ...
    def test_generate_max_value_test_cases_categories(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=validate_count, param_name="count", param_type="integer", max_value=100
        )
    ...
    def test_generate_max_value_test_cases_expected_behaviors(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=validate_score, param_name="score", param_type="float", max_value=100.0
        )
    ...
    def test_generate_max_value_test_cases_list_with_element_type(self, generator):
        ...
        int_test_cases = generator.generate_max_value_test_cases(
            function=process_numbers, param_name="numbers", param_type="list", max_value=5, element_type=int
        )
        ...
        float_test_cases = generator.generate_max_value_test_cases(
            function=process_numbers, param_name="numbers", param_type="list", max_value=5, element_type=float
        )
    ...
    def test_generate_max_value_test_cases_descriptions(self, generator):
        ...
        test_cases = generator.generate_max_value_test_cases(
            function=my_function, param_name="param", param_type="integer", max_value=100
        )
        ...
        for tc in test_cases:
            if tc["test_type"] == "at_max":
                assert (
                    "max_value" in tc["description"]
                    or "max_length" in tc["description"]
                    or "max_keys" in tc["description"]
                )
    ...
    def test_generate_concurrent_test_cases_basic(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(
            function=increment_counter, num_threads=[2, 5], num_operations=[10, 100], operation_type="write"
        )
    ...
    def test_generate_concurrent_test_cases_default_params(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(function=sample_function)
    ...
    def test_generate_concurrent_test_cases_race_condition(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(
            function=update_shared_resource, operation_type="same_resource"
        )
    ...
    def test_generate_concurrent_test_cases_stress_test(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(function=process_request, operation_type="mixed")
    ...
    def test_generate_concurrent_test_cases_write_conflict(self, generator):
        ...
        # 测试写操作类型
        write_test_cases = generator.generate_concurrent_test_cases(function=write_data, operation_type="write")
        ...
        # 测试混合操作类型
        mixed_test_cases = generator.generate_concurrent_test_cases(function=write_data, operation_type="mixed")

        write_conflict_cases = [tc for tc in mixed_test_cases if tc["test_type"] == "write_conflict"]
        assert len(write_conflict_cases) == 1

        # 测试只读操作类型（不应该有写冲突测试）
        read_test_cases = generator.generate_concurrent_test_cases(function=write_data, operation_type="read")
    ...
    def test_generate_concurrent_test_cases_read_consistency(self, generator):
        ...
        # 测试读操作类型
        read_test_cases = generator.generate_concurrent_test_cases(function=read_data, operation_type="read")
        ...
        # 测试混合操作类型
        mixed_test_cases = generator.generate_concurrent_test_cases(function=read_data, operation_type="mixed")

        read_consistency_cases = [tc for tc in mixed_test_cases if tc["test_type"] == "read_consistency"]
        assert len(read_consistency_cases) == 1

        # 测试只写操作类型（不应该有读一致性测试）
        write_test_cases = generator.generate_concurrent_test_cases(function=read_data, operation_type="write")
    ...
    def test_generate_concurrent_test_cases_deadlock_detection(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(function=acquire_locks, operation_type="mixed")
    ...
    def test_generate_concurrent_test_cases_baseline(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(function=process_item, operation_type="read")
    ...
    def test_generate_concurrent_test_cases_single_thread_count(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(
            function=sample_function, num_threads=10, num_operations=[1, 10]
        )
    ...
    def test_generate_concurrent_test_cases_single_operation_count(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(
            function=sample_function, num_threads=[2, 5], num_operations=50
        )
    ...
    def test_generate_concurrent_test_cases_descriptions(self, generator):
        ...
        test_cases = generator.generate_concurrent_test_cases(function=my_concurrent_function, operation_type="mixed")
    ...
    def test_generate_concurrent_test_cases_operation_types(self, generator):
        ...
        # 测试读操作
        read_cases = generator.generate_concurrent_test_cases(function=sample_function, operation_type="read")
        ...
        # 测试写操作
        write_cases = generator.generate_concurrent_test_cases(function=sample_function, operation_type="write")
        ...
        # 测试混合操作
        mixed_cases = generator.generate_concurrent_test_cases(function=sample_function, operation_type="mixed")
