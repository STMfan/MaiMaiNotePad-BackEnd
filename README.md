...
- **[🛠️ 管理工具使用指南](docs/guides/管理工具使用指南.md)** - manage.sh 完整使用文档
- **[🔧 API 文档](docs/api/API文档.md)** - REST API 接口说明
- **[🏗️ 架构文档](docs/architecture/架构文档.md)** - 系统架构设计
- **[🧪 测试文档](tests/docs/测试说明.md)** - 测试策略和方法
- **[❌ 错误码文档](docs/development/错误码文档.md)** - 错误码说明
- **[⚙️ 配置文档](docs/configuration/配置管理文档.md)** - 配置管理说明
- **[🛠️ 脚本工具](scripts/脚本说明.md)** - 维护脚本说明
- **[📝 更新日志](docs/guides/更新日志.md)** - 版本历史
...
**管理工具功能：**
- 🌐 **环境管理** - 创建虚拟环境（Conda/venv/uv）、查看项目状态、依赖管理、配置管理
- 🚀 **服务管理** - 启动开发/生产服务器、Docker 管理
- 🧪 **测试相关** - 运行测试、生成覆盖率报告
- 🧹 **项目维护** - 清理项目、数据库管理、代码质量检查
- ⚙️ **高级操作** - 初始化管理员、清档重置
...
详细使用说明请参考：[管理工具使用指南](docs/guides/管理工具使用指南.md)
